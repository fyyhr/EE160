...
int main()
{
  ...
  printf("Enter the first weight and value you would like to average (weight first, separated with a space): ");
  ...
  while (flag != EOF) {
    ...
    count++;
                /*  Get the next input     */
    printf("Enter the next weight and value you would like to average (weight first, separated with a space): ");
